...
1. Daily
  - Содержит скрипты и данные по всему, что связано с Apple Music, Deezer, VK, Яндекс.Музыкой, Сберзвуком
...
4. Sber_daily_parsing
- запускается каждый день в 18:25

5. Make_weekly_sber
- рассчитывает еженедельный чарт Сберзвук
- должен запускаться в любое время пятницы (можно и в 00:01)

6. Make_weekly_charts
