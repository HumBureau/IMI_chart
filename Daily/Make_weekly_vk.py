...
for ch in all_curr_week_charts:
    ...
    ch_html.columns = ["Неделя", "Позиция", "Изменение позиции vs прошлая неделя", "Лучшая позиция с начала наблюдений (02/10/20 - 08/10/20)", "Название", "Артист", "Жанр", "Недель в чарте с начала наблюдений (02/10/20 - 08/10/20)", "Лейбл"]                     
