...
spotify_curr_week_html = spotify_curr_week[["rank", "delta_rank", "best_pos",
                                            "title", "artist", "streams", "delta_streams", "weeks_in_chart", "week"]]
spotify_curr_week_html.columns = ["Позиция", "Изменение позиции", "Лучшая позиция",
                                  "Название", "Артист", "Прослушивания", "Динамика прослушиваний", "Недель в чарте", "Неделя"]
...
# удаляем запятые в числах (нужно было для работы со стырами данными
# all_spotify["streams"] = all_spotify['streams'].str.replace(",", "").astype(int)
